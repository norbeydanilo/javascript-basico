...
// Asignación del valor a las variables x, z
...
/* 
 * Operadores lógicos.
 * Los operadores lógicos que se utilizan para la toma de decisiones en los algoritmos de acuerdo a ciertas 
 * condiciones que se le den. El valor que devuelven estos operadores siempre es booleano.
 * - Negación ! 
 * - AND &&
 * - OR ||
*/
 ...
 * Permiten realizar operaciones matemáticas. Los operadores que se utilizan más comunmente son: 
 * - Suma (+)
 * - Resta (-)
 * - Multiplicación (*) 
 * - División (/)
...
console.log(`La variable ${a} es menor que ${b}: ${menor}`)
console.log(`La variable ${a} es mayor o igual que ${b}: ${mayorIgual}`)
console.log(`La variable ${a} es menor o igual que ${b}: ${menorIgual}`)
console.log(`La variable ${a} es igual que ${b}: ${igual}`)
console.log(`La variable ${a} es distinta que ${b}: ${distinto}`)